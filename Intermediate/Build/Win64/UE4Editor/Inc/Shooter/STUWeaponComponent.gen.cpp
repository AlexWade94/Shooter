...
#include "Shooter/Public/STUWeaponComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USTUWeaponComponent_Statics::Class_MetaDataParams[] = {
		...
		{ "IncludePath", "STUWeaponComponent.h" },
		{ "ModuleRelativePath", "Public/STUWeaponComponent.h" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USTUWeaponComponent_Statics::NewProp_WeaponEquipSocketName_MetaData[] = {
		{ "Category", "Weapon" },
		{ "ModuleRelativePath", "Public/STUWeaponComponent.h" },
	};
#endif
	const UE4CodeGen_Private::FNamePropertyParams Z_Construct_UClass_USTUWeaponComponent_Statics::NewProp_WeaponEquipSocketName = { "WeaponEquipSocketName", nullptr, (EPropertyFlags)0x0020080000010001, UE4CodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USTUWeaponComponent, WeaponEquipSocketName), METADATA_PARAMS(Z_Construct_UClass_USTUWeaponComponent_Statics::NewProp_WeaponEquipSocketName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USTUWeaponComponent_Statics::NewProp_WeaponEquipSocketName_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USTUWeaponComponent_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USTUWeaponComponent_Statics::NewProp_WeaponEquipSocketName,
	...
	IMPLEMENT_CLASS(USTUWeaponComponent, 3268378519);
	template<> SHOOTER_API UClass* StaticClass<USTUWeaponComponent>()
	{
		return USTUWeaponComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USTUWeaponComponent(Z_Construct_UClass_USTUWeaponComponent, &USTUWeaponComponent::StaticClass, TEXT("/Script/Shooter"), TEXT("USTUWeaponComponent"), false, nullptr, nullptr, nullptr);
