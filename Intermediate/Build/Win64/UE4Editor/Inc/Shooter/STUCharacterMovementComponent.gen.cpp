...
#include "Shooter/Public/STUCharacterMovementComponent.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SHOOTER_API UClass* Z_Construct_UClass_USTUCharacterMovementComponent_NoRegister();
	SHOOTER_API UClass* Z_Construct_UClass_USTUCharacterMovementComponent();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USTUCharacterMovementComponent_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "STUCharacterMovementComponent.h" },
		{ "ModuleRelativePath", "Public/STUCharacterMovementComponent.h" },
	};
#endif
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(USTUCharacterMovementComponent, 3510114346);
	template<> SHOOTER_API UClass* StaticClass<USTUCharacterMovementComponent>()
	{
		return USTUCharacterMovementComponent::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_USTUCharacterMovementComponent(Z_Construct_UClass_USTUCharacterMovementComponent, &USTUCharacterMovementComponent::StaticClass, TEXT("/Script/Shooter"), TEXT("USTUCharacterMovementComponent"), false, nullptr, nullptr, nullptr);
