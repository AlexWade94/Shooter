...
#include "Shooter/Public/STUBaseWeapon.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_WeaponMeshComponent_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_WeaponMeshComponent;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASTUBaseWeapon_Statics::NewProp_WeaponMeshComponent_MetaData[] = {
		{ "Category", "Components" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/STUBaseWeapon.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASTUBaseWeapon_Statics::NewProp_WeaponMeshComponent = { "WeaponMeshComponent", nullptr, (EPropertyFlags)0x002008000009000d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASTUBaseWeapon, WeaponMeshComponent), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASTUBaseWeapon_Statics::NewProp_WeaponMeshComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASTUBaseWeapon_Statics::NewProp_WeaponMeshComponent_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ASTUBaseWeapon_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ASTUBaseWeapon_Statics::NewProp_WeaponMeshComponent,
	...
	IMPLEMENT_CLASS(ASTUBaseWeapon, 1680883705);
	template<> SHOOTER_API UClass* StaticClass<ASTUBaseWeapon>()
	{
		return ASTUBaseWeapon::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASTUBaseWeapon(Z_Construct_UClass_ASTUBaseWeapon, &ASTUBaseWeapon::StaticClass, TEXT("/Script/Shooter"), TEXT("ASTUBaseWeapon"), false, nullptr, nullptr, nullptr);
